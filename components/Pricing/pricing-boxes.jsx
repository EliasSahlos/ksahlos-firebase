        ...
        <div className="md:flex md:justify-center md:items-center md:flex-wrap grid grid-cols-2 gap-2 p-2">
            <div className="bg-white md:w-[250px] shadow-md rounded p-2" data-aos="zoom-in-up" data-aos-duration="800">
                <ul className="text-sm text-center">
                    <li className="mb-2 font-semibold">Fine Art Copies</li>
                    <hr className="mb-2"/>
                    <li className="mb-4">(20€)</li>
                    <li className="text-white bg-black rounded mx-14 md:mx-24 mb-4">A4</li>
                    <li className="mb-9">FOTOSPEED Fine Art Paper</li>
                    <li className="mb-4">Signed By The Artist</li>
                    <li className="mb-4">Original Copy</li>
                    <li className="mb-4">-</li>
                    <li className="mb-4">-</li>
                    <li className="mb-4">Printed Using Dye Based Inks</li>
            ...
            <div className="bg-white md:w-[250px] shadow-md rounded p-2" data-aos="zoom-in-up" data-aos-duration="800"
                ...
                <ul className="text-sm text-center">
                    ...
                    <li className="text-white bg-black rounded mx-14 md:mx-24 mb-4">A3+</li>
                    <li className="mb-4 ">HUHNEMUHLE Fine Art Museum Quality Paper</li>
                    <li className="mb-4">Signed By The Artist</li>
